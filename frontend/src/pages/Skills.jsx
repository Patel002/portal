  ...
  const successAudio = new Audio('/src/assets/success.mp3');
    ...
    const handleDelete = async (id) => {
       Swal.fire({
        ...
        try {
            await axios.delete(`${Api_base_Url}/skill/delete-skill?id=${id}`);
            fetchTitle();
            setError('');
        } catch (error) {
            console.log(error);
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            const response = await axios.patch(`${Api_base_Url}/skill/update-skill?id=${editData.id}`, { skillName });
            setSkillsName('');
            setEditData(null);
            setError('');
            fetchTitle();
    ...
    const fetchTitle = async () => {
        try {
            const res = await axios.get(`${Api_base_Url}/skill/skill`);
    ...
    const handleAddskills = async (e) => {
        ...
        try {
            ...
            const res = await axios.post(`${Api_base_Url}/skill/add-skill`, { skillName, created_by: adminId },
                {
                    headers: {
                            ...
                            <div className="card">
                                <div className="card-header bg-white text-black">
                                    <h3 className="card-title">
                                        ...
                                        {editData ? "Edit Skills" : " Add Skills"}
                                    </h3>
                                </div>
                                <div className="card-body">
                                    <form onSubmit={editData ? handleUpdate : handleAddskills}>
                                        <div className="mb-3">
                                            <input
                                                type="text"
                                                value={skillName}
